...
Here's an example of how to use it.  TODO: this code block incurs an error while
rendering because flowsmooth is not yet fully available to use at this stage of
the code. Fix this!
